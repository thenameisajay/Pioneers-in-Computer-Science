...
router
  .post("/", async (req, res) => {
    ...
    const includesRelatedPhrase = relatedPhrases.some((phrase) =>
    ...
    const includesProhibitedPhrase = prohibitedPhrases.some((phrase) =>
    ...
    if (includesProhibitedPhrase) {
      answer =
        "I'm sorry, I don't understand. Please ask me about pioneers of computer science.";
      return res.render(path.join(__dirname, "../views/chat.ejs"), {
        message: message,
        answer: answer,
      });
